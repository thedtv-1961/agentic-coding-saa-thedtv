...
export default async function AwardCard({ category }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden rounded-3xl group-hover:shadow-[0_0_16px_0_rgba(250,226,135,0.5)]">
        <Image
